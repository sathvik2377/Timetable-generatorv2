...
export default function FacultyDashboard() {
  ...
  const loadInitialData = async () => {
    try {
      ...
      const teacherData = await apiClient.getTeachers()
      const currentTeacher = teacherData.find(t => t.user === userData.id)
      ...
      if (currentTeacher) {
        ...
        if (active) {
          ...
          const teacherSessions = sessionsData.filter(s => s.teacher === currentTeacher.id)
          setSessions(teacherSessions)
          
          // Filter today's sessions
          const today = new Date().getDay()
          const todaysSessions = teacherSessions.filter(s => s.day_of_week === today)
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            {currentSession ? (
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    {currentSession.class_group_details?.name}
                  </p>
                </div>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">No current session</p>
              </div>
            )}
          </motion.div>
          ...
          <motion.div
            ...
            className="glass-card p-6"
          >
            <h3 className="text-lg font-semibold text-white mb-4">Next Session</h3>
            {nextSession ? (
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    {nextSession.class_group_details?.name}
                  </p>
                </div>
                <div className="flex items-center space-x-4 text-sm text-gray-400">
                  <div className="flex items-center space-x-1">
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-400">No more sessions today</p>
              </div>
            )}
          </motion.div>
        </div>
        ...
        {activeTimetable && (
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-xl font-bold text-white">My Timetable</h2>
